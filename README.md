...
Optional: Arduino Uno/Nano with vibration motors for haptic feedback
...
Game Control – The inputs control a PC fighting game (e.g., Tekken 3 via emulator).

Optional Feedback – Arduino generates vibration feedback to simulate impact.

🧪 Example Usage
Run Real-Time Gesture Control
python Inference.py

Test Pose Estimation on Static Image
python Predict.py
